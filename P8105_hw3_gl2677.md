...
4966
  ...
  - `packaged vegetables fruits` is the most frequently ordered aisles,
    and `dog food care` is the least frequently ordered ones.
...
```
  ...
  - In 2002, total `6` states (\[most locations first\]`PA, MA, NJ, CT,
    FL, NC`) were observed at 7 or more locations. The range of the
    number of locations in the state is from 10 to 7.
  - In 2010, total `14` states (\[most locations first\]`FL, NJ, TX, CA,
    MD, NC, NE, WA, MA, NY, OH, CO, PA, SC`) were observed at 7 or more
    locations. The range of the number of locations in the state is from
    41 to 7.
  - The number of locations in the state increases in 2010 comparing to
    2002.
...
<img src="P8105_hw3_gl2677_files/figure-gfm/two-panel-1.png" width="90%" />
  ...
  - The peaks of `data_value` decrease for `Poor` and `Fair` in 2010
    comparing to thoes in 2006, and the peaks of `data_value` increase
    for Excellent`,`Good`and`Very good\` in 2010 comparing to thoes in
    2006.
